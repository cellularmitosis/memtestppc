 ...
 * ----------------------------------------------------
 * MemTest86+ V1.00 Specific code (GPL V2.0)
...
static float athloncoef[] = {11, 11.5, 12.0, 12.5, 5.0, 5.5, 6.0, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10.5};
static float athloncoef2[] = {12, 19.0, 12, 20.0, 13.0, 13.5, 14.0, 21.0, 15, 22, 16, 16.5, 17, 18.0, 23, 24};
...
static struct pci_memory_controller controllers[] = {
	...
	{ 0x1039, 0x5600, "SiS 5600",  0, poll_fsb_nothing, poll_timings_nothing, setup_nothing, poll_nothing },
        ...
        { 0x1039, 0x0650, "SiS 650",   0, poll_fsb_nothing, poll_timings_nothing, setup_nothing, poll_nothing },
        { 0x1039, 0x0651, "SiS 651",   0, poll_fsb_nothing, poll_timings_nothing, setup_nothing, poll_nothing },
        ...
        { 0x1039, 0x0655, "SiS 655",   0, poll_fsb_nothing, poll_timings_nothing, setup_nothing, poll_nothing },
        { 0x1039, 0x0648, "SiS 648",   0, poll_fsb_nothing, poll_timings_nothing, setup_nothing, poll_nothing },
	...
	/* ATi */
	{ 0x1002, 0x5830, "ATi Radeon 9100 IGP", 0, poll_fsb_nothing, poll_timings_nothing, setup_nothing, poll_nothing },
	{ 0x1002, 0x5831, "ATi Radeon 9100 IGP", 0, poll_fsb_nothing, poll_timings_nothing, setup_nothing, poll_nothing },
	{ 0x1002, 0x5832, "ATi Radeon 9100 IGP", 0, poll_fsb_nothing, poll_timings_nothing, setup_nothing, poll_nothing },
	{ 0x1002, 0x5833, "ATi Radeon 9100 IGP", 0, poll_fsb_nothing, poll_timings_nothing, setup_nothing, poll_nothing },
	
	/* nVidia */
	{ 0x10de, 0x01A4, "nVidia nForce", 0, poll_fsb_amd32, poll_timings_nothing, setup_nothing, poll_nothing },
	...
	{ 0x1106, 0x3099, "VIA KT266(A)/KT333", 0, poll_fsb_amd32, poll_timings_kt266, setup_nothing, poll_nothing },
	{ 0x1106, 0x3189, "VIA KT400(A)/600", 0, poll_fsb_amd32, poll_timings_kt266, setup_nothing, poll_nothing },
	...
	{ 0x8086, 0x1A30, "Intel i845",      0, poll_fsb_nothing, poll_timings_nothing, setup_i845, poll_i845 },
        { 0x8086, 0x2560, "Intel i845E/G/PE/GE", 0, poll_fsb_nothing, poll_timings_nothing, setup_i845, poll_i845 },
	{ 0x8086, 0x2500, "Intel i820",      0, poll_fsb_nothing, poll_timings_nothing, setup_i820, poll_i820 },
	{ 0x8086, 0x2530, "Intel i850",      0, poll_fsb_nothing, poll_timings_nothing, setup_i850, poll_i850 },
	{ 0x8086, 0x2570, "Intel i865P/PE/G", 0, poll_fsb_i875, poll_timings_i875, setup_i875, poll_nothing },
	...
	{ 0x8086, 0x7190, "Intel i440[bz]x", 0, poll_fsb_nothing, poll_timings_nothing, setup_nothing, poll_nothing },
	{ 0x8086, 0x7192, "Intel i440[bz]x", 0, poll_fsb_nothing, poll_timings_nothing, setup_nothing, poll_nothing },
	...
	{ 0x8086, 0x2540, "Intel E7500",    1, poll_fsb_nothing, poll_timings_nothing, setup_iE7xxx, poll_iE7xxx },
	{ 0x8086, 0x254C, "Intel E7501",    0, poll_fsb_nothing, poll_timings_nothing, setup_iE7xxx, poll_iE7xxx },
	{ 0x8086, 0x255d, "Intel E7205",     0, poll_fsb_nothing, poll_timings_nothing, setup_iE7xxx, poll_iE7xxx },
};
